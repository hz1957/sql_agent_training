...
# 4x H100 GRPO Experiment S3: tree-final reward, ppo_epochs=3, temperature 1.0.
# Launch from the outer workspace root:
#   bash sql_agent_training/scripts/run_verl_grpo_qwen25_coder_14b_h100_4gpu_s3_ep3.sh
...
RUN_NAME="${RUN_NAME:-verl_grpo_s3_ep3_tree_final_14b_h100_4gpu_150step_bs2_n20_t10_turn3_g09_branch4_beam2_$(date +%Y%m%d_%H%M%S)}"
