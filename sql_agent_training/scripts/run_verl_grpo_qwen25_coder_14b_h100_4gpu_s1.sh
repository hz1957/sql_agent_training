...
# 4x H100 GRPO Experiment S1: chain-final reward, temperature 1.0.
# Launch from the outer workspace root:
#   bash sql_agent_training/scripts/run_verl_grpo_qwen25_coder_14b_h100_4gpu_s1.sh
...
RUN_NAME="${RUN_NAME:-verl_grpo_s1_chain_final_14b_h100_4gpu_150step_bs8_n4_t10_turn3_g09_$(date +%Y%m%d_%H%M%S)}"
