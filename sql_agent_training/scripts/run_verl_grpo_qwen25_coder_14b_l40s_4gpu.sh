...
SQL_AGENT_REWARD_SCHEME=${SQL_AGENT_REWARD_SCHEME:-final_shared}
SQL_AGENT_REWARD_GAMMA=${SQL_AGENT_REWARD_GAMMA:-0.9}
SQL_AGENT_TRANSITION_SELECTION=${SQL_AGENT_TRANSITION_SELECTION:-round_robin}
...
export SQL_AGENT_REWARD_SCHEME
export SQL_AGENT_REWARD_GAMMA
export SQL_AGENT_TRANSITION_SELECTION
...
echo "verl SQL_AGENT_REWARD_SCHEME=${SQL_AGENT_REWARD_SCHEME} SQL_AGENT_REWARD_GAMMA=${SQL_AGENT_REWARD_GAMMA} SQL_AGENT_TRANSITION_SELECTION=${SQL_AGENT_TRANSITION_SELECTION}"
...
ROLLOUT=(
  ...
  +actor_rollout_ref.rollout.agent.reward_scheme="${SQL_AGENT_REWARD_SCHEME}"
  +actor_rollout_ref.rollout.agent.reward_gamma="${SQL_AGENT_REWARD_GAMMA}"
  +actor_rollout_ref.rollout.agent.transition_selection="${SQL_AGENT_TRANSITION_SELECTION}"
