...
# 4x H100 GRPO Experiment S4: tree-executable reward, temperature 1.0.
# Launch from the outer workspace root:
#   bash sql_agent_training/scripts/run_verl_grpo_qwen25_coder_14b_h100_4gpu_s4.sh
...
RUN_NAME="${RUN_NAME:-verl_grpo_s4_tree_executable_14b_h100_4gpu_150step_bs8_n36_t10_turn3_g09_beta01_branch4_beam4_$(date +%Y%m%d_%H%M%S)}"
...
(
  ...
  GRPO_REWARD_SCHEME=tree_executable \
