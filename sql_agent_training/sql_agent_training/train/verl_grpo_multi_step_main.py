...
def _import_multi_step_extensions() -> None:
    ...
    from sql_agent_training.train.verl_layered_summon import patch_verl_layered_summon
    from sql_agent_training.train.verl_prefix_cache import patch_verl_prefix_cache_config
